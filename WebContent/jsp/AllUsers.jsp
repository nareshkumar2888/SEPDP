							...
							<tbody>
								<c:forEach items="${details}" var="details">
									...
									<tr class="odd gradeX">
										...
										<td><a
											href="${pageContext.request.contextPath}/secure?query=UserActive&email=<c:out value="${details.email}"/>&&usertype=<c:out value="${details.usertype}"/>"
											class="btn btn-success">Active</a></td>
										<td><a
											href="${pageContext.request.contextPath}/secure?query=UserDeActive&email=<c:out value="${details.email}"/>&&usertype=<c:out value="${details.usertype}"/>"
